...
[CLICK HERE](https://github.com/sonic9l-music-wiki) to find the guide that suites your operating system.

### Commands

Commands are listed [here](https://github.com/sonic9l-music/MusicBot/wiki/Commands "Commands list").

### Configuration

The main configuration file is `config/options.ini`, but is not included.  Simply make a copy of `example_options.ini` and rename to `options.ini`.  See `example_options.ini` for more information on how to configure it.

[CLICK HERE](https://github.com/sonic9l-music/MusicBot/wiki/Configuration) for more details.
...
Some frequently asked questions are listed on the wiki [here](https://github.com/sonic9l-music/MusicBot/wiki/FAQ "Wiki").
